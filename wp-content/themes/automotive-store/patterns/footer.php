...
/**
 * Title: Footer
 * Slug: automotive-store/footer
 * Categories: automotive-store, footer
 */
?>
...
<p class="has-background-color has-text-color has-link-color has-merriweather-font-family">Proudly powered by <a rel="noreferrer noopener" href="https://templatehouse.net/" target="_blank">Automotive Store Themes</a> and <a href="https://wordpress.org">WordPress</a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->