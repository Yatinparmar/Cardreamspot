 ...
 * Slug: automotive-store/latest-products
 * Categories: automotive-store, latest-products
 */
?>
<!-- wp:group {"className":"product-section","layout":{"type":"constrained","contentSize":"83%"}} -->
