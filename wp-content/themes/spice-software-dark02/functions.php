            ...
            <div class="top-footer">
                ...
                <div class="social-proof">
                    <div class="social-proof-image">
                        <img src="http://localhost:8080/woocom/wordpress/wp-content/uploads/2024/04/logo44-removebg-preview.png" alt="Social Proof">
                    </div>
                </div>
                <!-- <div class="social-proof">
                    <div class="social-proof-image">
            ...
            <div class="bottom-footer">
                <div class="footer-logo">
                    <div class="footer-logo-image">
                        <a href="http://localhost/woocom/"><img src="http://localhost:8080/woocom/wordpress/wp-content/uploads/2024/04/20240418T114616617Z_998344094624_Footer-Logo1.png" alt="Footer Logo"></a>
                    </div>
                </div>
                ...
                <div class="footer-extras">
                    <div class="footer-tnc">
                        <div class="tnc-button-wrapper">
                            <a href="http://localhost:8080/woocom/wordpress/terms-condition/" class="tnc-button-link" role="button">
                    ...
                    <div class="footer-privacy">
                        <div class="privacy-button-wrapper">
                            <a href="http://localhost:8080/woocom/wordpress/privacy-policy-2/" class="privacy-button-link" role="button">
...
// hide the quentity in woocommerce product
function hide_quantity_input() {
    if (is_product()) {
        remove_action('woocommerce_before_add_to_cart_button', 'woocommerce_quantity_input_field');
    }
}
add_action('wp', 'hide_quantity_input');
